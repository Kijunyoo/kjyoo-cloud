...
// (/{lang}/cases/<slug>.html)를 build.mjs 가 여기서 만든다. draft: true 를 넣으면
// build.mjs 가 목록, 개별 페이지, sitemap 세 곳 전부에서 뺀다(3차 감사 W-5 지적,
...
export const CASES = {
  ko: [
    ...
    {
      slug: 'autopublish-selftest-0909',
      title: '자동발행 시험 케이스 (삭제 예정)',
      tag: '시험',
      date: '2026-09-09',
      summary: '자동생성 파이프라인 시험용 발췌입니다. 확인 후 삭제합니다.',
      body: [
        '첫 번째 시험 문단입니다. 자동생성 파이프라인이 이 문단을 그대로 옮기는지 확인합니다.',
        '두 번째 시험 문단입니다. 문단 두 개로 케이스 상세 페이지가 정상 렌더링되는지 봅니다.',
      ],
    },
  ],
  en: [
...
export const CONTENT = {
  ko: {
    ...
    index: {
      ...
      heroLead: '20여 명이 하던 개발, 제조, 마케팅, 서비스를',
      heroAccent: '한 사람과 AI가 합니다',
      heroBody: '한국, 중국, 유럽에 흩어져 있던 조직이 하던 일입니다. 40년간 그 일을 직접 기획하고 실행했고, 지금은 여러 AI에게 나눠주고 결과를 확인하는 방식으로 혼자 돌립니다.',
      ctaPrimary: '케이스 보기',
      stats: [
        { n: '30여 년', l: '글로벌 ICT 경력' },
        { n: '17년', l: 'CEO / C-Level' },
        { n: '30여 건', l: '특허 등록 및 출원' },
        { n: '20여 건', l: '정부 R&D 총괄' },
      ],
      sections: [
  ...
  en: {
    ...
    index: {
      ...
      heroLead: 'Work once done by 20 people',
      heroAccent: 'now runs with one person and AI',
      heroBody: 'Development, manufacturing, marketing, service. This was the work of a team spread across Korea, China and Europe. For 40 years I planned and ran it myself, and today I hand it out to a set of AI agents and check what comes back.',
      ctaPrimary: 'Read the cases',
      stats: [
        { n: '30+ years', l: 'Years in global ICT' },
        { n: '17 years', l: 'Years as CEO / C-level' },
        { n: '30ish', l: 'Patents filed and granted' },
        { n: '20ish', l: 'Government R&D projects led' },
      ],
      sections: [
    ...
    cases: {
      ...
      tags: ['Marketing', 'Sales', 'Operations', 'MVP', 'Development', 'Manufacturing'],
